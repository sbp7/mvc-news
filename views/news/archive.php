...
<div id="main">
	<div class="shell">
		...
		<div id="content">
            ...
            <?php foreach ($newsArchive as $newsItem) : ?>
			<div class="col">
				<div class="post">
					<h2><?php echo $newsItem['title'] ?></h2>

					<p><?php echo $newsItem['date'].' '.$newsItem['author_name'] ?></p>
					<div class="cl">&nbsp;</div>
					<a href="<?php echo '/news/'.$newsItem['id'] ?>" class="more">more</a>
				</div>
			</div>
			<?php endforeach; ?>
			...
			<div class="col cols-2">
				<div class="post">
					<h2>Who we are?</h2>
					<img src="../../template/images/post-image3.gif" alt="" class="right" />
			...
			<div class="col cols-2 last">
				<div class="post">
					...
					<img src="../../template/images/post-image4.gif" alt="" class="right" />
					<div class="cl">&nbsp;</div>
				</div>
			</div>
		</div>
